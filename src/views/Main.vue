    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      ...
      <div class="sidebar-footer">
        <button class="collapse-btn" @click="sidebarCollapsed = !sidebarCollapsed">
          <svg v-if="sidebarCollapsed" class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="main-area">
      ...
      <header class="top-header">
        ...
        <button class="mobile-menu-btn" @click="mobileMenuOpen = !mobileMenuOpen">
          <svg v-if="mobileMenuOpen" class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="header-right">
          <div class="user-dropdown" ref="dropdownRef">
            <button class="user-trigger" @click="userDropdownOpen = !userDropdownOpen">
              ...
              <svg class="dropdown-arrow" :class="{ open: userDropdownOpen }" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div class="mobile-sidebar" :class="{ open: mobileMenuOpen }">
        ...
        <nav class="mobile-sidebar-nav">
          <button
            ...
            class="nav-item"
            :class="{ active: activeTab === menu.id }"
            @click="handleTabChange(menu.id); mobileMenuOpen = false"
          >
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path v-if="menu.id === 'today'" d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
              <path v-if="menu.id === 'today'" d="M9 22V12h6v10"></path>
      ...
      <main class="main-content">
        ...
        <my-courses v-if="activeTab === 'my-courses'"></my-courses>
        <resources-page v-if="activeTab === 'resources'"></resources-page>
